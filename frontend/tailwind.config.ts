...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-gold': 'linear-gradient(135deg, #D4AF37, #F4E4A0, #D4AF37)',
        'gradient-dark': 'linear-gradient(135deg, #0F172A, #1E293B)',
        'gradient-card-dark': 'linear-gradient(135deg, rgba(30,41,59,0.8), rgba(15,23,42,0.9))',
      ...
      boxShadow: {
        ...
        'gold-lg': '0 6px 20px 0 rgba(212, 175, 55, 0.5)',
      },
    },
  },
  plugins: [
